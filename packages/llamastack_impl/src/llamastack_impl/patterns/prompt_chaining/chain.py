# ABOUTME: Prompt chaining pattern implementation using LlamaStack via OpenAI Responses API.
# ABOUTME: Chains two prompts: extract specs -> transform to structured JSON.
