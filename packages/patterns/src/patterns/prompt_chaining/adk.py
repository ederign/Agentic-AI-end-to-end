# ABOUTME: Prompt chaining using Google's ADK with its built-in LiteLLM infrastructure.
# ABOUTME: Demonstrates SequentialAgent for multi-step pipelines.
...
# ADK uses LiteLLM internally - this goes directly to OpenAI (not via LlamaStack)
